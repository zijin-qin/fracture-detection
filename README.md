...
After implementing CNN and Vision Transformer (ViT) models, we chose to include EfficientNetB0 as an additional model due to its efficiency and complementary strengths. EfficientNetB0 is designed to be computational lightweight, making it an ideal choice for resource-constrained environments. It achieves a strong balance between accuracy and model complexity, providing a scalable architecture that effectively bridges the gap between CNNs and ViTs. While CNNs excel at capturing local spatial features, they 
become computationally expensive as they scale. On the other hand, ViTs effectively capture global relationships in data but require large datasets to successfully prevent overfitting. EfficientNetB0 addresses these limitations through its compound scaling technique, which optimizes depth, width, and input resolution simultaneously, achieving high accuracy with fewer parameters. 
...
![image](https://github.com/user-attachments/assets/788dbd76-7c5c-4da4-b4bb-0ec296b75d1f)  
  [link to CNN](https://github.com/zijin-qin/fracture-detection/blob/Milestone5/CNN_hyper_notebook.ipynb)
### Model 2 ViT:
...
![image](https://github.com/user-attachments/assets/fdda73e4-4a2b-4e29-b294-dd88823f54e1)
  ...
  [link to ViT](https://github.com/zijin-qin/fracture-detection/blob/Milestone5/VIT_notebook.ipynb)
